...
export const ColorPickerModal = ({
  ...
  if (isAddMode) {
    return (
      <>
        <div className="fixed inset-0 z-50 bg-black bg-opacity-40" onClick={() => setIsAddMode(false)} />
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
              <button onClick={() => setIsAddMode(false)} className="text-sm text-gray-500">キャンセル</button>
  ...
  if (isEditMode) {
    return (
      <>
        <div className="fixed inset-0 z-50 bg-black bg-opacity-40" onClick={handleClose} />
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl max-h-[80vh] flex flex-col overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
              <button onClick={() => setIsEditMode(false)} className="text-sm text-gray-500">キャンセル</button>
  ...
  return (
    <>
      <div className="fixed inset-0 z-50 bg-black bg-opacity-40" onClick={handleClose} />
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl max-h-[70vh] flex flex-col overflow-hidden">
          {/* Header */}
          <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
            <div className="w-16" />
