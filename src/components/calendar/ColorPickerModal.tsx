...
export const ColorPickerModal = ({
    ...
    return (
      <>
        ...
        <div className="fixed inset-x-0 bottom-0 z-[70] flex justify-center">
          <div
            className="w-full max-w-md bg-white rounded-t-3xl shadow-2xl max-h-[85vh] flex flex-col transition-transform border-t-2 border-[#FFA52F]/40"
  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-[70] flex justify-center">
        <div
          className="w-full max-w-md bg-white rounded-t-3xl shadow-2xl max-h-[90vh] flex flex-col transition-transform border-t-2 border-[#FFA52F]/40"
          style={{ transform: currentY ? `translateY(${currentY}px)` : 'translateY(0)' }}
          onClick={(e) => e.stopPropagation()}
        >
          {/* ヘッダー（ドラッグ可能） */}
